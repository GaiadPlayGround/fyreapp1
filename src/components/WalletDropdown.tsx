      ...
      <div className="relative">
        ...
        {isOpen && dropdownPosition && createPortal(
          ...
          >
            ...
            {/* Actions */}
            <div className={cn("p-3 space-y-1 border-b border-border", !isConnected && "opacity-50")}>
              <button 
                onClick={copyInviteLink} 
                disabled={!isConnected}
                className="flex items-center justify-between w-full px-2 py-1.5 text-xs font-sans text-foreground hover:bg-muted rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span className="flex items-center gap-2">
