      ...
      <div className="w-full max-w-2xl border-2 border-border rounded-lg p-6 sm:p-10 bg-card/30 relative z-10">
        <div className="text-center">
          ...
          <a 
            ...
            className="font-sans text-blue-500 hover:text-blue-600 transition-colors inline-block mt-6 text-sm"
          >
          ...
          <button
            onClick={onSwipeUp}
            className="mt-8 bg-[#005ae0] hover:bg-[#0047b3] text-white font-semibold text-lg py-3 px-12 transition-colors shadow-md rounded-xl border-4 border-dashed border-neutral-600 font-mono"
          >
            SWIPE UP
          </button>
        </div>
